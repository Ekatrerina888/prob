...
* tests/test_01_registration.py - файл с проверками Регистрации
* tests/test_02_login.py - файл с проверками Входа
* tests/test_03_profile.py - файл с проверками Личного кабинета, переходов и выхода из аккаунта
* tests/test_04_constructor.py - файл с проверками Раздела "Конструктор"
